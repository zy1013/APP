 ...
 <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button type="button" class="btn btn-primary" style="margin-bottom: 10px;">New Request</button>
                </div>             
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <tr class="gradeX">
                                        ...
                                        <td class="text-center">12:06 11/12/2018</td>
                                        <td class="text-center"><a href="#"><i class="fa fa-info-circle fa-fw"></i></a>read</td>
                                        <td class="text-center"><a href="#"><i class="fa fa-trash-o fa-fw"></i></a> </td>
                                    </tr>
                      
                                    <tr class="gradeA">
                                        <td class="text-center">account</td>
                                        <td class="text-center">18:11 12/12/2018</td>
                                        <td class="text-center"><a href="#"><i class="fa fa-info-circle fa-fw"></i></a>resolved</td>
                                        <td class="text-center"><a href="#"><i class="fa fa-trash-o fa-fw"></i></a></td>
                                    </tr>
                                    <tr class="gradeB">
                                        <td class="text-center">log</td>
                                        <td class="text-center">10:11 12/12/2018</td>
                                        <td class="text-center"><a href="#"><i class="fa fa-question-circle fa-fw"></i></a>waiting task</td>
                                        <td class="text-center"><a href="#"><i class="fa fa-trash-o fa-fw"></i></a></td>
                                    </tr>
                                </tbody>
                            </table>
...
<div class="row">           
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">                                            
                        <div class="panel-body">                           
                              <div class="alert" >
                                    <label style="font-size: 20px;margin-top: 30px;">Detail:                                      
                                    </label>
                                 <div class="form-group">
                                                <label for="disabledSelect">Type</label>
                                                <input class="form-control" id="disabledInput" type="text" placeholder="login request" disabled="">
                                            </div>
                                <div class="form-group">
                                            <label>Content</label>
