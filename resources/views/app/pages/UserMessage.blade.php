              ...
              <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a><i class="fa fa-user fa-fw"></i>Account<span class="fa arrow"></span></a>
                            ...
                            <ul class="chat">
                              <li>
                                  <div class="chat-body clearfix">
                                      <div class="header">
                                          <strong class="primary-font">yili</strong>
                              ...
                              <li>
                                  <div class="chat-body clearfix">
                                      <div class="header">
                                          ...
                                          <strong class="pull-right primary-font">erhuo</strong>
                                      </div>
                              ...
                              <li>
                                  <div class="chat-body clearfix">
                                      <div class="header">
                                          ...
                                          <strong class="pull-right primary-font">erhuo</strong>
                                      </div>                                     <p class="alert alert-success">
                                          Lorem ipsum dolor sit amet,consectetur adipiscing elit. Curabitur bibendum ornare dolor, quis ullamcorper ligula sodales.
                                      </p>
                                  </div>
                              </li>
