...
{{session('uid')}}
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <!-- /.dropdown-messages -->
                    <li><a href="Homepage.html"><i class="fa fa-repeat fa-fw"></i>refresh</a>
                    </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3><a href="#">Room:Living Room<span class="fa arrow"></span></a></h3>
                </div>
}
}
</div>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            ...
                            <div class="col-xs-9 text-right">
                                    <div class="huge">light 1</div>
                                    <div>status :<i class="fa fa-check"></i></div>
                                </div>
                            </div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">light 3</div>
                                    <div>status : <i class="fa fa-warning"></i></div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
    ...
    <div class="row">
                ...
                <div class="col-lg-12">
                    <h3><a href="#">Room:Kitchen<span class="fa arrow"></span></a></h3>            
                </div>
                               ...
                               <div class="col-xs-9">                                
                                  <div class="dataTables_length" id="dataTables-example_length">
                                    	<label>
                                    		...
                                    		25
                                    		<i class="fa glyphicon-plus"></i></label>
                                  </div>
                                </div>   
 ...
 <div class="row">
                ...
                <div class="col-lg-12">
                    <h3><a href="#">Room:Bedroom<span class="fa arrow"></span></a></h3>            
                </div>
